...
describe('SlugType', () => {
    ...
    test('SlugType.of(special).resolve({special: \'doesn\'t include special characters\')) returns \'doesnt-include-special-characters\'', () => {
        expect(
            SlugType.of('special').resolve({special: 'doesn\'t include special characters'}),
        ).toBe('doesnt-include-special-characters');
    });
});
